...
public class RateResource {
    ...
    public ResponseEntity<Rate> createRate(@Valid @RequestBody Rate rate) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/rates/" + rate.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, rate.getId().toString()))
            .body(rate);
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Rate>> getAllRates(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
