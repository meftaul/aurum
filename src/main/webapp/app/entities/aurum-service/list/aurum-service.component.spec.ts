...
describe('AurumService Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'aurum-service', component: AurumServiceComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.aurumServices?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to aurumServiceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAurumServiceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAurumServiceIdentifier).toHaveBeenCalledWith(entity);
