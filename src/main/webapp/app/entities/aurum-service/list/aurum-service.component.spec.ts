...
import { sampleWithRequiredData } from '../aurum-service.test-samples';
...
describe('AurumService Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.aurumServices()[0]).toEqual(expect.objectContaining({ id: 7727 }));
  });

  describe('trackId', () => {
    it('should forward to aurumServiceService', () => {
      const entity = { id: 7727 };
