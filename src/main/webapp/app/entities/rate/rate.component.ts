...
export class RateComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.rateService
      ...
      .subscribe(
        (res: HttpResponse<IRate[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInRates(): void {
    this.eventSubscriber = this.eventManager.subscribe('rateListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IRate[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
