...
export class TransactionHistoryComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITransactionHistory): number => this.transactionHistoryService.getTransactionHistoryIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.transactionHistories = dataFromBody;
  }
